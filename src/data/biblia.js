// Dados da Bíblia Ave Maria
// Estrutura: Livros com abreviações, nomes e número de capítulos

export const bibliaBooksData = {
  "old_testament": [
    ...
    { abbrev: "hc", name: "Habacuc", chapters: 3 },
...
export const getAllBooks = () => {
  return [
    ...bibliaBooksData.old_testament,
    ...bibliaBooksData.new_testament
  ];
};

export const getBookByAbbrev = (abbrev) => {
  return getAllBooks().find(book => book.abbrev === abbrev);
};

export const getTestamentBooks = (testament) => {
  return bibliaBooksData[testament] || [];
};
