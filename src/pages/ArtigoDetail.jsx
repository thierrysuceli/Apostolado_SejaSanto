          ...
          <div className="p-8 md:p-12">
            ...
            <div 
              className="prose prose-lg dark:prose-invert max-w-none
                ...
                prose-p:text-gray-800 dark:prose-p:text-gray-200 prose-p:leading-relaxed prose-p:text-justify prose-p:mb-4
                ...
                prose-blockquote:border-l-4 prose-blockquote:border-amber-500 prose-blockquote:bg-amber-50 dark:prose-blockquote:bg-amber-900/20 prose-blockquote:py-3 prose-blockquote:px-6 prose-blockquote:italic prose-blockquote:text-gray-800 dark:prose-blockquote:text-gray-200
                prose-ul:text-gray-800 dark:prose-ul:text-gray-200 prose-ul:list-disc
