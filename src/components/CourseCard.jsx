...
const CourseCard = ({ course }) => {
  ...
  const cardContent = (
    <div className="relative bg-gray-800/50 backdrop-blur-sm rounded-2xl overflow-hidden group cursor-pointer hover:shadow-2xl hover:shadow-amber-500/20 transition-all duration-500 border border-gray-700 hover:border-amber-500/50 flex h-[320px]">
      {/* Image Container - Lado Esquerdo */}
      <div className="relative w-2/5 overflow-hidden flex-shrink-0 bg-gradient-to-br from-gray-700 to-gray-900">
        <img 
      ...
      <div className="flex-1 p-6 flex flex-col justify-between min-w-0">
        ...
        <div>
          ...
          {/* Title */}
          <h3 className="text-white font-bold text-2xl mb-3 line-clamp-2 leading-tight group-hover:text-amber-500 transition-colors">
            {course.title}
          </h3>
        ...
        <div>
          ...
          {isLocked ? (
            ...
            <div className="flex items-center gap-2 text-amber-500 text-sm font-bold group-hover:gap-3 transition-all">
