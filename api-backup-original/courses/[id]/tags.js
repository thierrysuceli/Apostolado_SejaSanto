// =====================================================
// COURSE TAGS ENDPOINT
// =====================================================

import { supabaseAdmin } from '../../lib/supabaseServer.js';
import { authenticate, requireRole } from '../../middleware/auth.js';

// POST /api/courses/:id/tags - Adicionar tag ao curso
  ...
  try {
    ...
    if (tagError) {
      ...
      if (tagError.code === '23505') {
        return res.json({ message: 'Tag já existe para este curso' });
      }
      throw tagError;
    }
    ...
    console.error('Error adding course tag:', error);
    res.status(500).json({ error: error.message || 'Erro ao adicionar tag ao curso' });
  }
}
